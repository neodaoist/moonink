...
import "./unbundled/SVG.sol";
import "./unbundled/Utils.sol";
...
contract InkRendererPractice {
    //
    mapping(uint256 => MoonPhase) public moonPhases;

    constructor() {
        // 5
        moonPhases[0] = MoonPhase(
            "Full Moon",
            string.concat(
                svg.path(
                    svg.prop(
        ...
        return
            string.concat(
                ...
                svg.text(
                    ...
                    string.concat(svg.cdata("Moon Ink #"), utils.uint2str(_tokenId))
                ),
